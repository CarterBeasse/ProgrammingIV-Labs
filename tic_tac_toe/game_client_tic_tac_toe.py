...
from tic_tac_toe import TicTacToe, GameException
...
parser.add_argument("-m", "--module", metavar="MODULE", help="""The python module to get moves from. In the case of a networked game, this will be the player, in the case of a local game this will be the opponent.""")
...
if args.port or args.host:
    ...
    mod = __import__(args.module if args.module else "ui_player")
    ui_move = __import__("ui_player")
    play_local_game("human", ui_move, "computer", mod, timeout)
